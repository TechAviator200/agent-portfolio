          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-[#3dd9d9]/40 px-5 py-3 text-sm font-semibold text-[#3dd9d9] transition-all hover:border-[#3dd9d9] hover:bg-[#3dd9d9]/10 active:scale-[0.98]"
              >
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
